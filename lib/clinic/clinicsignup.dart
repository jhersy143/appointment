...
class ClinicSignupWidget extends StatefulWidget{
  @override
  ClinicSignupWidgetState createState(){
    return ClinicSignupWidgetState();
  }
}

class ClinicSignupWidgetState extends State<ClinicSignupWidget>{
  ...
  Future saveUsers(BuildContext context,
    ...
    var doc =  FirebaseFirestore.instance.collection('Clinics').doc();
                              ...
                              onPressed: (){
                                if(_formKey.currentState.validate()){
                                  ...
                                  Navigator.pop(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => ClinicLoginScreen(),
                                    ),
                                  );
                                }
