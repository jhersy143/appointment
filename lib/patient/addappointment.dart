...
class addappointmentFormWidgetState extends State<addappointmentFormWidget>{
  ...
  void _addclinicapointment(String date,String time,String clinicName,String appointmentDate) async{
    id =  await FlutterSession().get('id');
    name = await FlutterSession().get('name');
            ...
            builder:(BuildContext context, AsyncSnapshot<dynamic> snapshot) {
              ...
              if(snapshot.hasData){
                ...
                children = [ Padding(
                  ...
                  child: Text(typeappointment == "doctorappointment" ?snapshot.data[0]['doctorName']:snapshot.data[0]['clinicName']),
                ),
                  DateTimePicker(
