...
class MyAppointmentAllFormWidget extends StatefulWidget{
  @override
  MyAppointmentAllFormWidgetState createState(){
    return MyAppointmentAllFormWidgetState();
  }
}

class MyAppointmentAllFormWidgetState extends State<MyAppointmentAllFormWidget>{
                                      ...
                                      children: [
                                        ListTile(
                                          ...
                                          subtitle:  Row(
                                            ...
                                            children: [
                                              Text('Date:',style: TextStyle(color: Color(0xff212221),fontSize: 16),),
                                              Text(snapshot.data[index]['date'], style: TextStyle(color: Color(0xff212221),fontSize: 16),),
                                              Text(' '),
                                              Text('Time:',style: TextStyle(color: Color(0xff212221),fontSize: 16),),
                                              Text(snapshot.data[index]['time'],style: TextStyle(color: Color(0xff212221),fontSize: 16),),
