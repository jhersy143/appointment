...
class HistoryConsultFormWidget extends StatefulWidget{
  @override
  HistoryConsultFormWidgetState createState(){
    return HistoryConsultFormWidgetState();
  }
}

class HistoryConsultFormWidgetState extends State<HistoryConsultFormWidget>{
