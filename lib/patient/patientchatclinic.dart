...
class PatientChatClinicWidget extends StatefulWidget{
  @override
  PatientChatClinicWidgetState createState(){
    return PatientChatClinicWidgetState();
  }
}

class PatientChatClinicWidgetState extends State<PatientChatClinicWidget>{
                                              ...
                                              Padding(
                                                  ...
                                                  Column(
                                                    children: [
                                                      Padding(
                                                          padding: const EdgeInsets.all(8.0),
                                                          child:Text('Please Give us some details regarding your Appointment Request, '
                                                              'What Lab test your are Requesting?',
                                                  ...
                                                  Column(
                                                    children: [
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: ElevatedButton(onPressed: (){
                                                          //_addconsultation();
                                                          Navigator.push(context, MaterialPageRoute(builder: (context)=>addconsultScreen()));
                                                        }
